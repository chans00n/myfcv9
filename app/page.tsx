            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
              <div className="text-center lg:col-span-6 lg:text-left flex flex-col justify-center">
                ...
                <div className="mt-8 flex justify-center lg:justify-start">
                  ...
                  >
                    <Button className="bg-white hover:bg-gray-100 text-black border border-gray-200 rounded-full text-base sm:text-lg px-6 py-3 sm:px-8 sm:py-4 inline-flex items-center justify-center">
                      Deploy your own
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-center">
              ...
              <div className="mt-8 lg:mt-0 flex justify-center lg:justify-end">
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <Button className="bg-white hover:bg-gray-100 text-black border border-gray-200 rounded-full text-base sm:text-xl px-8 py-4 sm:px-12 sm:py-6 inline-flex items-center justify-center">
                    View the code
